        ...
        <div class="modal-update" v-show="modalUpdate">
          <div class="modal-update-box">
            ...
            <form @submit.prevent>
              ...
              <input type="number" v-model="client.phone" name="phone" aria-label="telefone" placeholder="Telefone" required />
              <input type="number" v-model="client.cpf"  name="cpf" aria-label="cpf" placeholder="CPF" required />
  ...
  methods: {
    async fetchClientInfo() {
      try {
        ...
        const BASE_URL = `http://localhost:3000/api/clients/${clientId}`;
